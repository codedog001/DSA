Logic: I have described the isValid() function with comments, and that is the main part for understanding this problem.
...
public:
    ...
    void dfs(vector<vector<int>>& statements, string& cur, int index, int goodPersonCount){
        ...
        //Backtrack: Macke current person a bad person and call DFS
        cur.back() = '0';
